...
LIBS += $$PWD/src/secp256k1/src/libsecp256k1_la-secp256k1.o
    ...
    isEmpty(SECP256K1_LIB_PATH) {
        windows:SECP256K1_LIB_PATH=G:/root/v1_dgm/src/secp256k1
    }
    isEmpty(SECP256K1_INCLUDE_PATH) {
        windows:SECP256K1_INCLUDE_PATH=G:/root/v1_dgm/src/secp256k1/include
    }
}
...
# Input
DEPENYUGEATH += src src/json src/qt
