...
std::string HelpMessage()
{
    ...
    strUsage += "  -port=<port>           " + _("Listen for connections on <port> (default: 33290)") + "\n";
    ...
    strUsage += "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 33291)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    /* Denominations
       ...
       For example:
       1YUGE+1000 == (.1YUGE+100)*10
       10YUGE+10000 == (1YUGE+1000)*10
    */
