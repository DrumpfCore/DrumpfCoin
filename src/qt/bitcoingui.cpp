    ...
    nWeight(0)
{
    ...
    setStyleSheet("#drumpfcoin { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #dedede, stop: 1 #efefef);  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolButton { color: #ffffff; font-size: 13px; font-weight: 400; font-family: 'Verdana'; padding: 5px; padding-left: 8px; border: none; }" 
                           ...
                           "#tabs { color: #000000; background-color: #006633; border: none; padding-top: 0px; padding-bottom: 0px; }");
