...
private slots:
    ...
    QString BuyYUGE(QString OrderType, double Quantity, double Rate);
    QString SellYUGE(QString OrderType, double Quantity, double Rate);
